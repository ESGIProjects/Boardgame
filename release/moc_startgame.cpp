...
QT_MOC_LITERAL(1, 10, 11), // "onStartGame"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 11) // "goScoreMenu"

    },
    "StartGame\0onStartGame\0\0goScoreMenu"
};
...
const QMetaObject StartGame::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_StartGame.data,
      qt_meta_data_StartGame,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *StartGame::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_StartGame.stringdata0))
        return static_cast<void*>(const_cast< StartGame*>(this));
